  ...
  return (
    <div className='flex h-screen items-center justify-center bg-gray-50 dark:bg-gray-900 p-4 transition-colors'>
      ...
      <div className='bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-xl w-full max-w-md animate-fade-in border border-gray-100 dark:border-gray-700'>
        ...
        <Link
          to='/login'
          className='text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 mb-4 inline-flex items-center gap-1'
        >
        ...
        <form onSubmit={handleSubmit} className='space-y-4'>
          ...
          <button
            disabled={loading}
            className='w-full bg-blue-600 text-white py-3 rounded-xl font-bold hover:bg-blue-700 transition flex justify-center items-center gap-2 shadow-lg shadow-blue-200 dark:shadow-none'
          >
